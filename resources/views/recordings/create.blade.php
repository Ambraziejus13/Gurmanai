<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
      <header class="text-center">
        <h2 class="text-2xl font-bold uppercase mb-1">Sukurkite recepto laidos įrašą</h2>
      </header>
  
      <form method="POST" action="/recipes/{{$recipe->id}}/recordings" enctype="multipart/form-data">
        @csrf
        <div class="mb-6">
          <label for="title" class="inline-block text-lg mb-2">Laidos pavadinimas</label>
          <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title"
            placeholder="Pvz: Gustavo enciklopedija" value="{{old('title')}}" />
        ...
        <div class="mb-6">
          ...
          placeholder="Pvz: Gustavas" value="{{old('host_name')}}" />
        ...
        <div class="mb-6">
          ...
          placeholder="Pvz: www.lrt.lt/mediateka/irasas/..." value="{{old('link')}}" />
